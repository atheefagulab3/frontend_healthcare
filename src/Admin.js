...
//   const fetchDoctors = () => {
//     axios
//       .get('https://localhost:7097/api/doctors')
...
//   const fetchPatients = () => {
//     axios
//       .get('https://localhost:7205/api/Patient')
//       .then(response => {
...
//       axios
//         .delete(`https://localhost:7205/api/Patient/${patientID}`)
//         .then(response => {
...
//       <div class="row">
//       <h5>When you Update Any Profile do inform the Required person </h5>
//       <p> update Them through Email</p>
//       <p>Inform The OP Doctor</p>
//       <div class="col-ml-6">
//         <div class="card">
//           <div class="card-body">
//             <h5 class="card-title">
//               Patient
//             </h5>
//             <p class="card-text">Here is the List of our Patients till Date.</p>
//             <a href="/Patient" class="btn btn-primary">View </a>
//           </div>
//         </div>
//       </div>
//       <p/>
...
//             <p class="card-text">Here is the List of our Doctors till Date.</p>
//             <a href="/Doctor" class="btn btn-primary">View</a>
//           </div>
//         </div>
//       </div>
//     </div>
...
//         </div>
//         <div className="w-3/4">
//           <div className="content p-4 text-black">
